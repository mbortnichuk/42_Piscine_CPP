...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/20 19:53:28 by mbortnic          #+#    #+#             */
/*   Updated: 2018/06/20 19:53:29 by mbortnic         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) {
	...
	std::cout << b.getRangedAttackDamage() << std::endl;
	...
	std::cout << c.getRangedAttackDamage() << std::endl;
